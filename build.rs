...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let build_directory = config
        ...
        .define("SUPPORT_FILEFORMAT_PNG", "OFF")
        .define("SUPPORT_FILEFORMAT_BMP", "OFF")
        .define("SUPPORT_FILEFORMAT_TGA", "OFF")
        .define("SUPPORT_FILEFORMAT_JPG", "OFF")
        .define("SUPPORT_FILEFORMAT_GIF", "OFF")
        .define("SUPPORT_FILEFORMAT_PSD", "OFF")
        .define("SUPPORT_FILEFORMAT_DDS", "OFF")
        .define("SUPPORT_FILEFORMAT_HDR", "OFF")
        .define("SUPPORT_FILEFORMAT_KTX", "OFF")
        .define("SUPPORT_FILEFORMAT_ASTC", "OFF")
        .define("SUPPORT_FILEFORMAT_PKM", "OFF")
        .define("SUPPORT_FILEFORMAT_PVR", "OFF")
