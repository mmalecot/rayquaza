...
fn main() -> Result {
    ...
    while !window.should_close() {
        window.draw(|canvas| {
            ...
            canvas.draw_circle_lines(window.get_width() / 4, 340, 80.0, Color::DARKBLUE);
            canvas.draw_rectangle(window.get_width() / 4 * 2 - 60, 100, 120, 60, Color::RED);
            canvas.draw_rectangle_horizontal_gradient(
                window.get_width() / 4 * 2 - 90,
                170,
                180,
                130,
                Color::MAROON,
            ...
            canvas.draw_triangle(
                (window.get_width() as f32 / 4.0 * 3.0, 80.0),
                (window.get_width() as f32 / 4.0 * 3.0 - 60.0, 150.0),
                (window.get_width() as f32 / 4.0 * 3.0 + 60.0, 150.0),
                Color::VIOLET,
            );
            canvas.draw_triangle_lines(
                (window.get_width() as f32 / 4.0 * 3.0, 160.0),
